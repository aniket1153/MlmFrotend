...
if (showForgotPassword) return (
  <ForgetPassword onVerifyOtp={() => {
    setShowForgotPassword(false);
    setShowotp(true);
  }} />
);

  if (showLogin) return <Login onForgotPassword={() => setShowForgotPassword(true)} />;
   if (showotp) return <VerifyOtp onResetPassword={() => setShowResetPassword(true)} />;
if (showotp) return (
  <VerifyOtp onResetPassword={() => {
    setShowotp(false);
