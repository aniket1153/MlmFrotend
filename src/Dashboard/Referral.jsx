...
import referralImg from '../assets/Group 2.png'; // Make sure the path is correct
...
const Referral = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md w-full h-full">
      <h2 className="text-3xl font-semibold mb-2">Referral</h2>
      <p className="text-gray-500 mb-4 text-lg">Share Your Unique Referral Code.</p>
      ...
      <div className="flex flex-wrap md:flex-nowrap items-center gap-2 mb-4">
        <input
          ...
          className="border border-gray-300 px-4 py-2 rounded-full text-base md:text-lg font-mono w-full sm:w-64"
        />
        <button
          onClick={handleCopy}
